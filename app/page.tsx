...
const features = [
  ...
  },
  {
    ...
    desc: 'Claude AI processes each CV, enhances content quality, extracts skills and experience, and standardizes profiles.',
    color: '#f0f9ff',
    accent: '#0284c7',
  },
  {
...
const steps = [
  ...
  { n: '02', title: 'AI Processes', desc: 'Claude AI reads, improves, and extracts structured data from each CV.' },
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '2rem' }}>
            {steps.map((step, i) => (
              <div key={step.n} style={{ position: 'relative', textAlign: 'center' }}>
                {i < steps.length - 1 && (
                  <div style={{
                    position: 'absolute', top: '28px', right: '-1rem', left: 'calc(50% + 36px)',
                    height: '2px', background: 'linear-gradient(90deg, #38bdf8, #e5e7eb)',
                    display: 'none',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            <div>
              ...
              <div style={{ display: 'flex', gap: '1rem' }}>
                ...
                <Link href="/jobs" className="btn-secondary">Post a Job</Link>
              </div>
            </div>
            <div>
              {[
